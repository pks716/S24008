...
# Training hyperparameters (matching your Fast-DDPM style)
...
#     """Compute normalized Sobel edge magnitude. img: [B,1,H,W], values in [-1,1] or [0,1]."""
#     import torch.nn.functional as F
    ...
    while global_iteration < n_iters:
        ...
        if global_iteration % validation_freq == 0:
            ...
            with torch.no_grad(), autocast(dtype=AMP_DTYPE):
                ...
                # Cycle through different source modalities
